 ...
 * features.
 * <p>
 * You must use an {@link ExpandableRecyclerView.ExpandableAdapter}
 * instead of a {@link RecyclerView.Adapter} and an
 * {@link ExpandableRecyclerView.ExpandableViewHolder} instead of a
...
public class ExpandableRecyclerView extends BaseRecyclerView {
    ...
    /**
     * {@link RecyclerView.ItemAnimator} used for normal operations
     */
    ...
    /**
     * Interface definition for a callback to be invoked when a group in this expandable list has been
     * clicked. Similar to {@link ExpandableListView.OnGroupClickListener}.
     */
    ...
    /**
     * A ViewHolder describes an item view and metadata about its place within the
     * ExpandableRecyclerView.
     * <p>
     * <p>
     * {@link ExpandableAdapter} implementations should subclass ExpandableViewHolder and add fields
     * for caching potentially expensive {@link View#findViewById(int)} results.
     * </p>
     * <p>
     * <p>
     * While {@link LayoutParams} belong to the {@link LayoutManager}, {@link ViewHolder ViewHolders}
     * belong to the adapter. Adapters should feel free to use their own custom ViewHolder
     * implementations to store data that makes binding view contents easier. Implementations should
     * assume that individual item views will hold strong references to {@code ExpandableViewHolder}
     * objects and that {@code ExpandableRecyclerView} instances may hold strong references to extra
     * off-screen item views for caching purposes
     * </p>
     */
    public static class ExpandableViewHolder extends cn.ffb.adapter.recycler.ViewHolder
            implements
            OnClickListener {
     ...
     * {@link ExpandableRecyclerView}.
     * </p>
     */
    public static abstract class ExpandableAdapter<T>
            extends RecyclerView.Adapter<ExpandableViewHolder> implements ExpandHandler {
...
//            setViewHolderFactory(new ViewHolderFactory<ExpandableViewHolder>() {
//
//                @Override
//                public ExpandableViewHolder createViewHolder(View itemView) {
//                    return onCreateExpandableViewHolder((ViewGroup) itemView, 0);
//                }
//            });
        }

        /**
         * Equivalent of {@link RecyclerView.Adapter#onCreateViewHolder(ViewGroup, int)} for an
         * {@code ExpandableRecyclerView}.
         *
         * Called when ExpandableRecyclerView needs a new {@link ExpandableViewHolder} of the given type
         * to represent an item.
         *
         * This new ExpandableViewHolder should be constructed with a new View that can represent the
         ...
         * {@link #onBindGroupView(ExpandableViewHolder, int)} and child items with
         * {@link #onBindChildView(ExpandableViewHolder, int, int)}. Since it will be re-used to display
         ...
         */
        @NonNull
        protected abstract ExpandableViewHolder onCreateExpandableViewHolder(ViewGroup parent, int viewType);

        /**
         * Equivalent of {@link RecyclerView.Adapter#onBindViewHolder(RecyclerView.ViewHolder, int)} for
         * a group View.
         *
         * Called by ExpandableRecyclerView to display the data at the specified position. This method
         * should update the contents of the {@link ExpandableViewHolder#itemView} to reflect the item
         * at the given position.
         *
         * Note that unlike {@link android.widget.ListView}, ExpandableRecyclerView will not call this
         * method again if the position of the item changes in the data set unless the item itself is
         * invalidated or the new position cannot be determined. For this reason, you should only use
         * the <code>position</code> parameter while acquiring the related data item inside this method
         * and should not keep a copy of it. If you need the position of an item later on (e.g. in a
         * click listener), use {@link ExpandableViewHolder#getPosition()} which will have the updated
         * position.
         *
         ...
         */
        protected abstract void onBindGroupView(ExpandableViewHolder holder, int groupPosition);
         ...
         * @param groupPosition The group position of the item within the adapter's data set.
         */
        protected abstract void onBindChildView(ExpandableViewHolder holder, int groupPosition, int childPosition);

        /**
         * Get the amount of groups in the adapter. Similar to
         * {@link android.widget.ExpandableListAdapter#getGroupCount()
         * ExpandableListAdapter.getGroupCount()}.
         */
        protected abstract int getGroupCount();

        /**
         * Gets the number of children in a specified group. Similar to
         * {@link android.widget.ExpandableListAdapter#getChildrenCount(int)
         * ExpandableListAdapter.getChildrenCount()}.
         */
        protected abstract int getChildrenCount(int groupPosition);

        /**
         * Equivalent of {@link RecyclerView.Adapter#getItemViewType(int)} for a group View.
         *
         * Return the view type of the item at {@code groupPosition} for the purposes of view recycling.
         *
         * <p>
         * Unlike ListView adapters, types need not be contiguous. Consider using id resources to
        ...
        /**
         * Equivalent of {@link RecyclerView.Adapter#getItemViewType(int)} for a child View.
         *
         * Return the view type of the item at {@code groupPosition} for the purposes of view recycling.
         *
         * <p>
        ...
        public final ExpandableViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            ExpandableViewHolder result = onCreateExpandableViewHolder(parent, viewType);
            return result;
        }

        @Override
        public final void onBindViewHolder(ExpandableViewHolder holder, int groupPosition) {
            if (DEBUG)
                Log.d(LOG_TAG, this + " onBindViewHolder(pos=" + groupPosition + ") expanded="
                        + expandedPosition + " count=" + expandedChildCount);
            ...
            if (expandedPosition == RecyclerView.NO_POSITION || groupPosition <= expandedPosition) {
                ...
                if (!BuildConfig.DEBUG) {
                    try {
                        ...
                        Log.e(LOG_TAG, this + " failed onBindViewHolder(pos=" + groupPosition + ") expanded="
                                + expandedPosition + " count=" + expandedChildCount, e);
                    }
                } else {
                    onBindChildView(holder, expandedPosition, groupPosition - expandedPosition - 1);
                }
        ...
        private void setExpandedViewHolder(@NonNull ExpandableViewHolder expandedViewHolder,
                                           boolean isExpanded, boolean forceUpdate) {
        ...
        /**
         * Stables IDs using Parcelable instead of long using {@link #getGroupStableId(int)} and
         * {@link #getGroupStableIdPosition(Parcelable)}
         */
         ...
         * {@link ExpandableRecyclerView.ExpandableAdapter#hasStableIds()}
         * by allowing a {@code Parcelable} rather than a {@code long}.
         * <p>
         * It can be {@link #STABLE_IDS_NONE}, {@link #STABLE_IDS_LONG} or
         * {@link #STABLE_IDS_PARCELABLE}.
         * </p>
         * <p>
         * You must override {@link #getGroupStableId(int)} and
         * {@link #getGroupStableIdPosition(Parcelable)} for this to work properly.
         * </p>
         */
        ...
        /**
         * Similar to {@link android.widget.ExpandableListAdapter#getGroupId(int)
         * ExpandableListAdapter.getGroupId()} when using {@link #STABLE_IDS_LONG} with
         * {@link #setStableIdsMode(int)}. Otherwise {@link #getGroupStableId(int)} is used.
         */
        ...
        /**
         * Get the stable ID at group position so the position can be recovered properly. Returns
        ...
        /**
         * Get the group position corresponding to the specified {@code stableId} to recover the
         * position of that group. Returns {@link #NO_POSITION} by default.
         */
        ...
        public final int getItemCount() {
            return getGroupCount()
                    + (expandedPosition != RecyclerView.NO_POSITION ? expandedChildCount : 0);
        }
        ...
        public final int getItemViewType(int groupPosition) {
            ...
            if (expandedPosition == RecyclerView.NO_POSITION || groupPosition <= expandedPosition) {
                ...
                if (viewType < 0) {
                    throw new IllegalStateException("invalid viewType " + viewType + " for position "
                            + groupPosition + " expandedPosition=" + expandedPosition + " expandedChildCount="
                            + expandedChildCount);
                }
            } else if (groupPosition - expandedPosition <= expandedChildCount) {
                ...
                if (DEBUG)
                    Log.d(LOG_TAG,
                            ExpandableAdapter.this
                                    + " the expanded position is not valid anymore expandedPosition="
                                    + expandedGroupPosition + " groupCount=" + getGroupCount());
                expandedGroupPosition = RecyclerView.NO_POSITION;
            }

            if (this.expandedPosition != expandedGroupPosition) {
                if (DEBUG)
                    Log.d(LOG_TAG, this + " setExpandedPosition " + expandedGroupPosition + " from "
                            + expandedGroupPosition + " recyclerView=" + recyclerView);
            ...
            if (holderGroupPosition != RecyclerView.NO_POSITION) {
                ...
                if (expandedPosition != RecyclerView.NO_POSITION) {
                    if (holderGroupPosition <= expandedPosition) {
                        ...
                        if (strict) {
                            throw new IndexOutOfBoundsException("expand an invalid ViewHolder holderPosition="
                                    + holderGroupPosition + " expanded=" + expandedPosition + " count="
                                    + expandedChildCount + " holder=" + holder);
                        }
                    } else {
        ...
        public final void onViewExpand(ExpandableViewHolder holder) {
            ...
            if (DEBUG)
                Log.w(LOG_TAG, this + " onViewExpand groupPos=" + holderGroupPosition + " holder="
                        + holder + " recyclerView=" + recyclerView);
            if (null != recyclerView.onGroupClickListener && recyclerView.onGroupClickListener
                    .onGroupClick(recyclerView, holder.itemView, holderGroupPosition, 0))
        ...
        void attachRecyclerView(ExpandableRecyclerView recyclerView) {
            if (DEBUG) Log.w(LOG_TAG,
                    this + " attachRecyclerView recyclerView=" + recyclerView + " was " + this.recyclerView);
            this.recyclerView = recyclerView;
        }

        @Override
        public void onViewRecycled(ExpandableViewHolder holder) {
        ...
        public void notifyDataChanged() {
            ...
            if (expandedStableId != null) {
                ...
                if (!useLegacyStableIds) {
                    if (DEBUG) Log.i(LOG_TAG,
                            this + " notifyDataChanged recovering expanded position for " + expandedStableId);
            ...
            if (null != recyclerView && recyclerView.selectedStableId != null) {
                if (!useLegacyStableIds) {
                    if (DEBUG) Log.i(LOG_TAG,
                            this + " notifyDataChanged recovering selected position for " + expandedStableId);
        ...
        public void notifyGroupChanged(int groupPosition) {
            ...
            if (DEBUG) Log.d(LOG_TAG,
                    this + " notifyGroupChanged(" + groupPosition + ") start=" + modifiedStart + " count="
                            + itemChangedCount + " expanded=" + expandedPosition + " headerCount="
                            + getHeaderViewsCount());
        ...
        public void notifyGroupInserted(int groupPosition) {
            ...
            if (DEBUG) Log.d(LOG_TAG,
                    this + " notifyGroupInserted(" + groupPosition + ") start=" + modifiedStart + " count="
                            + itemChangedCount + " expanded=" + expandedPosition + " headerCount="
                            + getHeaderViewsCount());
        ...
        public void notifyGroupRemoved(int groupPosition) {
            ...
            if (DEBUG) Log.d(LOG_TAG,
                    this + " notifyGroupRemoved(" + groupPosition + ") start=" + modifiedStart + " count="
                            + itemChangedCount + " expanded=" + expandedPosition + " headerCount="
                            + getHeaderViewsCount());
    ...
    public void setExpandableAdapter(ExpandableAdapter adapter) {
        ...
        if (null != adapter) adapter.attachRecyclerView(this);
    }
    ...
    /**
     * Get the {@link RecyclerView.ItemAnimator} used to handle animations other than the
     * collapse/expand.
     */
    @Override
    ...
    /**
     * Set the {@link RecyclerView.ItemAnimator} used to handle animations other than the
     * collapse/expand.
     *
     * @param animator
     */
    ...
    private void expandAndCollapse(final int expandPosition, final int collapsePosition) {
        if (ExpandableAdapter.DEBUG) Log.d(ExpandableAdapter.LOG_TAG, "expandAndCollapse "
                + expandPosition + '/' + collapsePosition + " currentAnimator=" + super.getItemAnimator());

        final ItemAnimator currentItemAnimator = super.getItemAnimator();
        if (DEBUG_ANIMATOR) Log.d(ANIM_TAG,
                "expandAndCollapse(" + expandPosition + ',' + collapsePosition + ") with current animator="
                        + currentItemAnimator + " isRunning="
                        + (currentItemAnimator != null && currentItemAnimator.isRunning())
                        + " mUserItemAnimator=" + mUserItemAnimator);
        if (currentItemAnimator != null) {
            ...
            currentItemAnimator.isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                ...
                public void onAnimationsFinished() {
                    ExpandAndCollapseItemAnimator expandAnimator =
                            new ExpandAndCollapseItemAnimator(expandPosition, collapsePosition);
                    if (DEBUG_ANIMATOR) Log.i(ANIM_TAG,
                            "animation before expandAndCollapse with current animator=" + currentItemAnimator
                                    + " finished (running=" + currentItemAnimator.isRunning()
                                    + "), use expand ItemAnimator=" + expandAnimator);
    ...
    private void doExpandAndCollapse(final int expandPosition, final int collapsePosition) {
        ...
        boolean collapseChanged = expandableAdapter.expandedPosition != RecyclerView.NO_POSITION
                && collapsePosition == expandableAdapter.expandedPosition;
        // collapse
        if (collapseChanged) {
            if (ExpandableAdapter.DEBUG) Log.d(ExpandableAdapter.LOG_TAG,
                    "collapse group " + collapsePosition + " in " + getExpandableAdapter());
            getAdapter().notifyItemRangeRemoved(collapsePosition + getHeaderViewsCount() + 1,
                    expandableAdapter.getChildrenCount(collapsePosition));
        ...
        if (expandedChanged) {
            ...
            getAdapter().notifyItemRangeInserted(expandPosition + getHeaderViewsCount() + 1,
                    childViewCount);
            if (ExpandableAdapter.DEBUG) Log.d(ExpandableAdapter.LOG_TAG,
                    "expand group " + expandPosition + " in " + getExpandableAdapter());
        }
        ...
        if (collapseChanged || expandedChanged) {
            ...
            if (expandPosition != RecyclerView.NO_POSITION) {
                if (getLayoutManager() instanceof LinearLayoutManager) {
                    ...
                    // Log.e(LOG_TAG, "lastFull =
                    // "+linearLayoutManager.findLastCompletelyVisibleItemPosition()+"
                    // group+Child"+(groupPosition + childViewCount));
                    if (linearLayoutManager.findFirstVisibleItemPosition() < expandPosition
                            + getHeaderViewsCount()
                            && linearLayoutManager.findLastCompletelyVisibleItemPosition() < expandPosition
                            + getHeaderViewsCount()) {
            ...
            // dirty trick to scroll to show the last visible expandable item when it's not visible and do
            // some other stuff
            ViewCompat.postOnAnimationDelayed(this, new Runnable() {
                @Override
                public void run() {
                    ExpandableRecyclerView.super.getItemAnimator()
                            .isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                                @Override
                                public void onAnimationsFinished() {
                                    if (DEBUG_ANIMATOR)
                                        Log.i(ANIM_TAG, "animation to expand finished, do scroll if needed");
                                    if (getExpandableAdapter() == null) return;

                                    if (collapsePosition != RecyclerView.NO_POSITION) {
                                        ExpandableViewHolder viewHolder = (ExpandableViewHolder) findViewHolderForPosition(
                                                collapsePosition + getHeaderViewsCount());
                                        if (null != viewHolder) {
                                    ...
                                    if (expandPosition != RecyclerView.NO_POSITION) {
                                        ExpandableViewHolder viewHolder = (ExpandableViewHolder) findViewHolderForPosition(
                                                expandPosition + getHeaderViewsCount());
                                        if (null != viewHolder) {
                                        ...
                                        if (getLayoutManager() instanceof LinearLayoutManager) {
                                            ...
                                            if (linearLayoutManager.findFirstVisibleItemPosition() < expandPosition
                                                    + getHeaderViewsCount()
                                                    && linearLayoutManager
                                                    .findLastCompletelyVisibleItemPosition() < expandPosition
                                                    + getHeaderViewsCount() + childViewCount) {
                                                if (ExpandableAdapter.DEBUG)
                                    ...
                                    if (DEBUG_ANIMATOR) Log.i(ANIM_TAG,
                                            "animation finished set back mUserItemAnimator=" + mUserItemAnimator);
    ...
    private void doSetSelectedGroup(int groupPosition) {
        if (groupPosition < 0) groupPosition = RecyclerView.NO_POSITION;

        if (groupPosition != selectedGroup) {
            if (ExpandableAdapter.DEBUG) Log.d(ExpandableAdapter.LOG_TAG,
                    "doSetSelectedGroup(" + groupPosition + ") selectedGroup=" + selectedGroup);
            if (selectedGroup != RecyclerView.NO_POSITION) {
                ExpandableViewHolder selectedViewHolder =
                        (ExpandableViewHolder) findViewHolderForPosition(selectedGroup);
            ...
            if (getExpandableAdapter().hasStableIds()) {
                if (getExpandableAdapter().useLegacyStableIds)
                    selectedStableId = new ExpandableAdapter.LongParcelable(
                            getExpandableAdapter().getGroupId(groupPosition));
                else
    ...
    /**
     * Equivalent of {@link ExpandableListView#setSelectedGroup(int)} for an
     * {@code ExpandableRecyclerView}.
     */
    ...
    /**
     * Equivalent of {@link ExpandableListView#getSelectedPosition()} for an
     * {@code ExpandableRecyclerView}.
     */
    ...
    /**
     * Equivalent of
     * {@link ExpandableListView#setOnGroupExpandListener(ExpandableListView.OnGroupExpandListener)}
     * for an {@code ExpandableRecyclerView}.
     */
    ...
    /**
     * Equivalent of
     * {@link ExpandableListView#setOnGroupCollapseListener(ExpandableListView.OnGroupCollapseListener)}
     * for an {@code ExpandableRecyclerView}.
     */
    ...
    /**
     * Equivalent of
     * {@link ExpandableListView#setOnGroupClickListener(ExpandableListView.OnGroupClickListener)} for
     * an {@code ExpandableRecyclerView}.
     */
    ...
    private void changeRange(final int groupPosition, final int childCount) {
        if (super.getItemAnimator() == mUserItemAnimator) {
            ...
            if (DEBUG_ANIMATOR) Log.i(ANIM_TAG,
                    "changeRange with no current animator mUserItemAnimator=" + mUserItemAnimator);
            super.setItemAnimator(mUserItemAnimator);
            getAdapter().notifyItemRangeChanged(groupPosition + getHeaderViewsCount(), childCount);
        } else {
            if (DEBUG_ANIMATOR) Log.i(ANIM_TAG, "changeRange with current custom animator "
                    + super.getItemAnimator() + " isRunning=" + super.getItemAnimator().isRunning());
            super.getItemAnimator().isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                @Override
                public void onAnimationsFinished() {
                    if (DEBUG_ANIMATOR)
    ...
    private void insertRange(final int groupPosition, final int childCount) {
        if (super.getItemAnimator() == mUserItemAnimator) {
            ...
            if (DEBUG_ANIMATOR) Log.i(ANIM_TAG,
                    "insertRange with no current animator mUserItemAnimator=" + mUserItemAnimator);
            super.setItemAnimator(mUserItemAnimator);
            getAdapter().notifyItemRangeInserted(groupPosition + getHeaderViewsCount(), childCount);
        } else {
            if (DEBUG_ANIMATOR) Log.i(ANIM_TAG, "insertRange with current custom animator "
                    + super.getItemAnimator() + " isRunning=" + super.getItemAnimator().isRunning());
            super.getItemAnimator().isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                @Override
                public void onAnimationsFinished() {
    ...
    private void removeRange(final int groupPosition, final int childCount) {
        if (super.getItemAnimator() == mUserItemAnimator) {
            ...
            if (DEBUG_ANIMATOR) Log.i(ANIM_TAG,
                    "removeRange with no current animator mUserItemAnimator=" + mUserItemAnimator);
            super.setItemAnimator(mUserItemAnimator);
            getAdapter().notifyItemRangeRemoved(groupPosition + getHeaderViewsCount(), childCount);
        } else {
            if (DEBUG_ANIMATOR) Log.i(ANIM_TAG, "removeRange with current custom animator "
                    + super.getItemAnimator() + " isRunning=" + super.getItemAnimator().isRunning());
            super.getItemAnimator().isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                @Override
                public void onAnimationsFinished() {
    ...
    private final Runnable refreshDisplay = new Runnable() {
        @Override
        public void run() {
            if (getLayoutManager() instanceof LinearLayoutManager && isFirstLayoutPassed()
                    && getExpandableAdapter() != null) {
    ...
    public void refreshDisplay() {
        ...
        if (DEBUG_ANIMATOR) Log.d(ANIM_TAG, "refreshDisplay current animator=" + currentItemAnimator
                + " running=" + (currentItemAnimator != null && currentItemAnimator.isRunning()));
        if (currentItemAnimator == null) {
            ...
            currentItemAnimator.isRunning(new ItemAnimator.ItemAnimatorFinishedListener() {
                ...
                public void onAnimationsFinished() {
                    if (DEBUG_ANIMATOR)
                        Log.i(ANIM_TAG, "animation before refreshDisplay with current animator="
                                + currentItemAnimator + " finished, do refresh");
                    removeCallbacks(refreshDisplay);
                    post(refreshDisplay);
                }
            });
    ...
    private class ExpandAndCollapseItemAnimator extends DefaultItemAnimator {
        ...
        public void onRemoveFinished(ViewHolder item) {
            if (DEBUG_ANIMATOR) Log.v(ANIM_TAG,
                    this + " onRemoveFinished finished item=" + item + " isRunning=" + isRunning());
            ...
            if (!collapseListenerCalled && item instanceof ExpandableViewHolder) {
                int holderPosition =
                        getExpandableAdapter().getHolderGroupPosition((ExpandableViewHolder) item, false);
        ...
        public void onAddFinished(ViewHolder item) {
            if (DEBUG_ANIMATOR) Log.v(ANIM_TAG,
                    this + " onAddFinished finished item=" + item + " isRunning=" + isRunning());
