...
import cn.ffb.adapter.recycler.OnRecyclerViewItemLongClickListener;
import cn.ffb.adapter.recycler.RecyclerAdapter;


/**
 * 可以添加HeaderView和FooterView以及EmptyView的RecyclerView
 * <p>
 * Created by lingfei on 2017/5/22.
 */
public abstract class BaseRecyclerView extends RecyclerView {
    ...
    private class WrapAdapter extends Adapter<cn.ffb.adapter.recycler.ViewHolder> {
        ...
        @Override
        public void onViewAttachedToWindow(cn.ffb.adapter.recycler.ViewHolder holder) {
        ...
        @Override
        public cn.ffb.adapter.recycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_HEADER) {
                return new cn.ffb.adapter.recycler.ViewHolder(mHeaderViews.get(mHeaderPosition++));
            } else if (viewType == TYPE_FOOTER) {
                return new cn.ffb.adapter.recycler.ViewHolder(mFooterViews.get(mFooterPosition++));
            }
        ...
        @Override
        public void onBindViewHolder(cn.ffb.adapter.recycler.ViewHolder holder, int position) {
